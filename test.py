...
def check_subscriber_output(c, client_id, target):
  ...
  print("Checking subscriber C" + client_id + " output")
  outc = c.get_output_timeout(1)
  print(" check_subscriber_output" + outc + " " + target)
...
def run_test_c2_subscribe_plus_wildcard(c2, topics):
  ...
  outc = c2.get_output_timeout(1)
  print("unsubscribe: " + outc)
